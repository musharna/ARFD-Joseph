...
published_file <- "ARFD_Up_Down_Regulated_LFC-1_p01_sorted.csv"
...
if (exists("published_df")) {
  ...
  if (nrow(lbd_comparison) > 0) {
    ...
    print(lbd_wide %>% select(Gene, Construct, Published_LFC, Current_LFC))
  }
